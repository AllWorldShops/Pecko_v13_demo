...
export class BomOverviewTable extends Component {
    ...
    get precision() {
     ...
     get showPosition() {
        return this.props.showOptions.position;
    }
     get showPart_no() {
        return this.props.showOptions.part_no;
    }
     get showDescription() {
        return this.props.showOptions.description;
    }
     get showManufacturer() {
        return this.props.showOptions.manufacturer;
    }
